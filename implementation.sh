...
echo "Please re-check the /orkitools directory and make sure that:
    1. The required files are eixst and check rsnapshot.conf.
    2. The required lines for the cPanel or NoncPanel are unhashed on demand"